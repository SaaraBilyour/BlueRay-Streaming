        ...
        <div class="container">
          <div class="d-sm-flex align-items-center justify-content-between">
            ...
            <?php
                ...
                if(!($fic_membres=fopen(FICHIER_MEMBRES,"a+")) || !($fic_connexion=fopen(FICHIER_CONNEXION,"a+"))){
                    echo "<br><br>Impossible d'ouvrir les fichiers";
                    exit;
                }
                $prenom = $_POST['prenom'];
                $nom = $_POST['nom'];
                ...
                $ligneMembres = $prenom.";".$nom.";".$courriel."\n";
                $ligneConnexion = $courriel.";".$pass.";1;"."M\n";
                fputs($fic_membres, $ligneMembres);
                fputs($fic_connexion,  $ligneConnexion);
                fclose($fic_membres);
                fclose($fic_connexion);
                
                echo "<h3>Membre ".$prenom." ".$nom." bien enregistre</h3>";
              ?>
            </h1>
            </div>
